...
규칙:
- title_ko / title_ko_jp / title_ko_full: 한국 팬덤이나 커뮤니티에서 널리 통용되는 번역 제목이 있으면 반드시 그것을 우선 사용하세요
  예: 紅蓮華 → 홍련화, 残酷な天使のテーゼ → 잔혹한 천사의 테제, ルーキー → 루키
  직역보다 실제 사용되는 표현을 우선하고, 통용 번역이 불확실할 때만 직접 번역하세요
